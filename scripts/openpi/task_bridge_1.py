...
from simpler_env.evaluation.bridge_tasks import widowx_task1_pick_object
...
if __name__ == "__main__":
    ...
    final_scores = widowx_task1_pick_object(env_policy=policy, ckpt_path=args.ckpt_path)
