...
echo "PI0-fast評価: bash /root/workspace/SimplerEnv/scripts/openpi/run_pi0_fast_evaluation.sh"
echo ""
echo "評価例:"
echo "  WidowXタスク: bash scripts/octo/run_widowx_evaluation.sh octo-base 4 bridge_table_1_v2 0 1"
echo "  PI0-fast Fractal: bash scripts/openpi/run_pi0_fast_evaluation.sh"
echo "  カスタムチェックポイント: bash scripts/openpi/run_pi0_fast_evaluation.sh /path/to/checkpoint"